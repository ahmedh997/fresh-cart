        ...
        <div className='py-6 max-w-lg mx-auto w-[90%]'>
            ...
            <form className="max-w-lg mx-auto text-left" onSubmit={formik.handleSubmit}>
                ...
                <div className='flex flex-col items-center mb-3'>
                    ...
                    <p className='text-sm mt-4 text-black'>Don't have account? <span className='font-bold'><Link className='underline' to={'/register'}>Register</Link></span></p>
                </div>
                
                <Link className='text-sm flex justify-center my-4' to={'/resetpassword'}>Reset Password</Link>
